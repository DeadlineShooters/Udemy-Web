			...
			<div className='flex'>
				...
				<div className='container mx-auto p-6 py-12 lg:px-12'>
					<div className='flex justify-between mt-4 mb-8 relative items-center'>
						<h1 className='text-4xl font-bold text-gray-700 '>Statistics</h1>
						<div ref={dropdownRef}>
							<button
							...
							{isDropdownOpen && (
								<div id='dropdownSearch' className='z-10 absolute top-full mt-2 right-0 bg-white rounded-lg shadow w-full md:w-[32rem] dark:bg-gray-700'>
									...
									<button
										class='font-medium justify-center w-full border-t-2 flex items-center p-2 text-gray-500 hover:text-[#a435f0]'
					...
					<div className='cardContainer relative flex flex-col rounded-xl bg-white text-gray-700 shadow'>
						<div class='dark:bg-gray-800 flex justify-center'>
							<div class='grid grid-cols-2 md:grid-cols-3 gap-6 p-4'>
								<button
									class={`${
										selectedChart === 'revenue' ? 'border-[#a435f0] bg-purple-50' : 'border-gray-500/50'
									} hover:border-[#a435f0] hover:bg-purple-50 flex flex-col justify-center gap-2 border-2 border-dashed  px-2 sm:px-4 lg:px-8 rounded-md dark:text-gray-200`}
									onClick={() => {
								...
								<button
									class={`${
										selectedChart === 'enrollment' ? 'border-[#a435f0] bg-purple-50' : 'border-gray-500/50'
									} hover:border-[#a435f0] hover:bg-purple-50 flex flex-col justify-center gap-2 border-2 border-dashed  px-2 sm:px-4 lg:px-8 rounded-md dark:text-gray-200`}
									onClick={() => {
								...
								<button
									class={`${
										selectedChart === 'rating' ? 'border-[#a435f0] bg-purple-50' : 'border-gray-500/50'
									} hover:border-[#a435f0] hover:bg-purple-50 flex flex-col justify-center gap-2 border-2 border-dashed  px-2 sm:px-4 lg:px-8 rounded-md dark:text-gray-200`}
									onClick={() => {
