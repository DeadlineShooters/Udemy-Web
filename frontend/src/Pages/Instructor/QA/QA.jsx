...
const QuestionAndAnswer = () => {
  ...
  return (
    <div className="flex w-full">
      ...
      <div className="container mx-auto p-6 py-6 lg:px-12">
        ...
        <div className="flex mt-4 relative items-end mb-8">
          ...
          <div className="flex flex-col filter-container mr-8">
            <select className="text-md font-bold hover:bg-gray-200" onChange={(e) => setSortOldest(e.target.value === "oldest")}>
              ...
              {selectedCourseId &&
                questions.slice(0, showMoreQuestions ? questions.length : 5).map((question) => (
                  <div key={question._id} onClick={() => {}}>
                    <div
                      className={`${question._id == selectedQuestion?._id ? "bg-gray-300" : ""} flex flex-row py-2 border-gray-600 border-b-[1px] hover:cursor-pointer hover:bg-gray-200`}
                      onClick={() => handleSelectingQuestion(question)}
                    >
          ...
          {selectedQuestion && (
            <div className="w-full h-full flex flex-col">
              ...
              <div className="p-2 overflow-y-auto flex-grow flex flex-col">
                {answers &&
                  answers.slice(0, showMoreAnswers ? answers.length : 5).map((answer, index) => (
                        ...
                        <div className="flex flex-row items-center justify-between">
                          ...
                          {answer.user._id === userData._id && (
                            <div className="relative">
                              <AiOutlineEllipsis className="h-6 w-6 text-gray-500 cursor-pointer ml-2" onClick={() => toggleDropdown(index)} />
      ...
      <WarningModal isOpen={showDeleteModal} onCancel={handleCancelDelete} onConfirm={handleConfirmDelete} />
    </div>
  );
};
