  ...
  return (
    <div className="template flex flex-row pt-8">
      ...
      <div className="flex flex-col border border-slate-500 w-1/2" style={{height: "40rem"}}>
        ...
        <div className='flex flex-row pt-5 pb-5 border border-x-0 border-t-0 border-slate-500 items-center'>
        ...
        <div className='pl-12 pt-5'>
          <button type="button" className="text-white bg-sky-950 hover:bg-sky-900 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Change password</button>
        </div>
      </div>
    </div>
  )
