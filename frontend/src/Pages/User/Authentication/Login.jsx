  ...
  return (
    <div className='flex flex-col w-full items-center pt-20 font-bold text-2xl mb-28'>
      ...
      <form className='flex flex-col w-full items-center' onSubmit={submit}>
        <div className='flex flex-row items-center border border-gray-600 py-2 px-2 w-96 mt-4 text-lg hover:bg-gray-100 cursor-pointer' onClick={googleAuth}>
          <img src={google_icon} className='px-3' alt="google_icon"/>
          <p>Continue with Google</p>
        </div>
        <div className='flex flex-row items-center border border-gray-600 py-2 px-2 w-96 mt-2 text-lg hover:bg-gray-100 cursor-pointer' onClick={facebookAuth}>
        ...
        <div className="relative z-0 w-96 mb-2 group">
          <input type="email" name="floating_email" id="floating_email" className="block py-4 px-2 w-full text-sm font-normal text-gray-900 bg-transparent border border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required onChange={(e) => {setEmail(e.target.value)}}/>
        ...
        <div className="relative z-0 w-96 mb-2 group">
          <input type="password" name="floating_password" id="floating_password" className="block py-4 px-2 w-full text-sm font-normal text-gray-900 bg-transparent border border-gray-600 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required onChange={(e) => {setPassWord(e.target.value)}}/>
