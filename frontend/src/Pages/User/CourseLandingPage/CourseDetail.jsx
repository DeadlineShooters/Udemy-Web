...
import { useCart, useWishlist } from '../../../CourseContextProvider.jsx';
			...
			<div className='course-details-outermost-container lg:py-5 lg:px-20 flex items-center px-6'>
				<div className='course-info-container lg:w-7/12 sm:10/12 md:px-10 sm:px-1'>
					...
					<div className='text-sm mt-5 mb-5'>
						...
						<br />
						<p>
							Learn software testing with this course and become a successful software tester/agile Tester. Obtain the core Mobile Testing, Backend testing,
							Web testing, and Test Engineering skills, and learn JIRA, SQL, TestRail, TestGear, Confluence, Charles Proxy, and GitHub. By the end of this
							course, you will have enough knowledge to get a job as a software tester or start working as a freelancer! We will also explain many testing
							platforms where you can start earning money as a beta tester.
						</p>
