				...
				{isLogged === true ? (
					<div className={`flex items-center`}>
						...
						<div className='relative' onMouseEnter={toggleWishlistDropdown} onMouseLeave={toggleWishlistDropdown}>
							<Link to='/home/my-courses/wishlist' id='dropdownSearchButton' className='flex items-center py-4 my-2' type='button'>
						...
						<div className='relative' onMouseEnter={toggleCartDropdown} onMouseLeave={toggleCartDropdown}>
							<Link to='/cart' id='dropdownSearchButton' className='flex items-center py-4 my-2' type='button'>
							...
							{isCartDropdownOpen && (
								...
								>
									<ul
										className='divide-y divide-gray-300 max-h-[32rem] pb-3 overflow-y-auto text-sm text-gray-700'
									...
									<div className='sticky bottom-0 w-full bg-white shadow-[0_-2px_4px_rgba(0,0,0,.08),0_-4px_12px_rgba(0,0,0,.08)] p-4'>
										<div className='flex gap-2 items-center mb-2'>
											...
											<span className='text-gray-700 line-through'>
												...
												{(amount / 0.8).toLocaleString('en-US', { style: 'currency', currency: 'USD' })}
											</span>
										</div>
