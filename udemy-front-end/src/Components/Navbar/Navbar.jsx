	...
	return (
		<div className='header'>
				...
				<div class='flex items-center'>
					...
					<form>
						...
						<div class='relative'>
							...
							<button
								type='submit'
								class='text-white absolute end-2.5 bottom-2.5 bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:outline-none focus:ring-purple-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800'
							>
								Search
							</button>
						</div>
            ...
            <Link to="/instructor">Instructor</Link>
					...
					<div className='flex items-center'>
						<button class='bg-white hover:bg-gray-200 text-black font-bold py-2 px-4 border-2 border-gray-900 rounded mx-2'>Login</button>
						<button class='bg-gray-800 hover:bg-gray-700 text-white font-bold py-2 px-4 border-2 border-gray-900 rounded'>Sign up</button>
					</div>
				)}
			</div>
			<div class='divider'>
